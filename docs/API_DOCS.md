...
_Figure 2: Execution of FastAPI ASGI server with Uvicorn worker process._

_Figure 3: Live telemetry streaming test verifying packet structure and 20 Hz broadcast rate._
